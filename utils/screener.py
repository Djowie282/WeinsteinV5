...
SECTORS = {
    ...
    "UFO":  "Space & Defense Tech (UFO)",
    "ARKK": "Innovation (ARKK)",
    "XBI":  "Biotech (XBI)",
    "ITB":  "Homebuilders (ITB)",
    "XOP":  "Oil & Gas E&P (XOP)",
    "GDX":  "Gold Miners (GDX)",
    "SIL":  "Silver Miners (SIL)",
    "COPX": "Copper Miners (COPX)",
    "REMX": "Rare Earth (REMX)",
    "HACK": "Cybersecurity (HACK)",
    "FINX": "Fintech (FINX)",
    "BOTZ": "Robotics & AI (BOTZ)",
    "DRIV": "EV & Autonomous (DRIV)",
    "LIT":  "Lithium & Battery (LIT)",
    "TAN":  "Solar Energy (TAN)",
    "ICLN": "Clean Energy (ICLN)",
    "PAVE": "Infrastructure (PAVE)",
    "MOO":  "Agribusiness (MOO)",
    "IHI":  "Medical Devices (IHI)",
    "JETS": "Airlines (JETS)",
    "HERO": "Video Gaming (HERO)",
    "KIE":  "Insurance (KIE)",
    "SOXX": "Semiconductors (SOXX)",
    "CIBR": "Cybersecurity (CIBR)",
    "AIQ":  "AI & Big Data (AIQ)",
    "ROBO": "Robotics (ROBO)",
    "SKYY": "Cloud Computing (SKYY)",
    "WCLD": "Cloud Computing (WCLD)",
    "IBB":  "Biotech Large (IBB)",
    "XHB":  "Homebuilders (XHB)",
    "XRT":  "Retail (XRT)",
    "ESPO": "eSports & Gaming (ESPO)",
    "FAN":  "Wind Energy (FAN)",
}
